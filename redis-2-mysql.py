...
if __name__ == '__main__':
    ...
    monitor_rate.GEN_DATA_STIME = monitor_amount.GEN_DATA_STIME = all_hash_data[0]['qrcode1_scanned_at'] if len(all_hash_data) else str(Today())
    ...
    try:
        ...
        # uois 长度为0时 设置 monitor_rate.GEN_DATA_ETIME
        if not monitor_rate.GEN_DATA_ETIME and not monitor_amount.GEN_DATA_ETIME:
            monitor_rate.GEN_DATA_ETIME = monitor_amount.GEN_DATA_ETIME = str(Today())
